...
/**
 * @description checkHoliday
 * @returns {boolean} working days is true else all false
 * @param {*} date 
 */
var checkHolidays = (date) => {
    let dateInfo = day2018.find((item) => item.dayStr ==  date.Format('yyyyMMdd'))
    // only working days return true
    return dateInfo.type === '0' ? true : false
